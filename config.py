...
TECH_COLUMN_LABELS = {
    ...
    "거래량돌파배수": "거래량돌파배수",
    "변동성압축": "변동성압축",
    "squeeze_on_hourly": "Squeeze_On(1H)",
    "squeeze_off_hourly": "Squeeze_Off(1H)",
    "squeeze_momentum_hourly": "Squeeze_Momentum(1H)",
    "squeeze_on": "Squeeze_On(1D)",
    "squeeze_off": "Squeeze_Off(1D)",
    "squeeze_momentum": "Squeeze_Momentum(1D)",
    "squeeze_on_weekly": "Squeeze_On(1W)",
    "squeeze_off_weekly": "Squeeze_Off(1W)",
    "squeeze_momentum_weekly": "Squeeze_Momentum(1W)",
    "squeeze_on_monthly": "Squeeze_On(1M)",
    "squeeze_off_monthly": "Squeeze_Off(1M)",
    "squeeze_momentum_monthly": "Squeeze_Momentum(1M)",
    "RSI": "RSI(1D)",
    "RSI_hourly": "RSI(1H)",
    "RSI_weekly": "RSI(1W)",
    "RSI_monthly": "RSI(1M)",
